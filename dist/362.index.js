...
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6441);
...
const textToDoc = async (embeddedSourceText, textToDocOptions) => {
	...
	const doc = await (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.jsTextToDoc)(parser === "typescript" || parser === "babel-ts" ? filepath?.endsWith(".tsx") ? "tsx" : "ts" : "jsx", embeddedSourceText, _oxfmtPluginOptionsJson, detectParentContext(parentParser, textToDocOptions));
